...
def targets_with_clusters_PIM1only(network_name, clusters_name, targets, all_shorps=False, top_size=200, target_size=200,
                          base_size=200, ax=None, top_colour='pink', base_colour='yellow', label_nodes = True,
                         base_shape = "s", plot_targets = True):
    """
    This function plots a target protein within its cluster in relation to ICP55 and PIM1
    ...
    # This is our subgraph layer of icp55 and pim1
    top_layer = network.subgraph([lib.constants.PIM1])
